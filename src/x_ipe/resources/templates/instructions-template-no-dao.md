...
2. **Create task via x-ipe-tool-task-board-manager** via `x-ipe-tool-task-board-manager` skill ← **BLOCKING**
...
6. **Update task status** via `x-ipe-tool-task-board-manager` ← **MANDATORY**
