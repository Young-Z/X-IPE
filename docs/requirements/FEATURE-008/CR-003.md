...
4. State persists to `docs/ideas/.ideation-tools.json`
...
- AC-30: `.ideation-tools.json` created in docs/ideas/ on first use
...
- Persistence: JSON file at `docs/ideas/.ideation-tools.json`
