...
**In Scope:**
- Theme folder discovery (`docs/themes/theme-*/`)
...
1. **Theme Discovery:** On app load, `ThemesService` scans `docs/themes/theme-*/` folders
...
6. **Sidebar Access:** Click "Themes" in sidebar → folder tree of `docs/themes/` → click file to view
...
class ThemeMetadata:
    ...
    path: str               # Relative path: "docs/themes/theme-default"
  ...
  "themes": [
    {
      ...
      "path": "docs/themes/theme-default"
    }
  ],
...
```json
{
  ...
  "visualization_path": "docs/themes/theme-default/component-visualization.html"
}
```
...
5. **Update `src/templates/index.html`:**
   ...
   - Wire click handler to load `docs/themes/` in file tree
...
|----------|-------------------|
| `docs/themes/` doesn't exist | Return empty list, themes section shows "No themes" |
