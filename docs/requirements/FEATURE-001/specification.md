...
- Process: Recursively scan configured directories (docs/planning, docs/requirements, src)
  ...
  "sections": [
    {
      ...
      "path": "docs/planning",
      "children": [
        {"name": "task-board.md", "type": "file", "path": "docs/planning/task-board.md"},
        {"name": "features.md", "type": "file", "path": "docs/planning/features.md"}
      ]
    }
  ]
}
...
```json
{
  ...
  "path": "docs/planning/new-file.md"
}
```
