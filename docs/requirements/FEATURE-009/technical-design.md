...
// Example state after docs/planning/features.md changes:
changedPaths = Set {
  "docs/planning/features.md",  // The file
  "docs/planning",               // Parent folder
...
getParentPaths("docs/planning/features.md")
→ ["docs/planning", "docs"]

// Normalize paths (remove trailing slashes, handle edge cases)
normalizePath("docs/planning/") → "docs/planning"
```
