...
flowchart TB
    ...
    subgraph Data["Data Layer"]
        Filesystem["Filesystem (docs/, config/)"]
...
- [ ] Diagrams stored in current idea folder (`docs/ideas/Draw Architecture Diagram for itself/`)
...
- [ ] Proceed to **Idea to Architecture** task
  ...
  - Store outputs in current idea folder (`docs/ideas/Draw Architecture Diagram for itself/`)
