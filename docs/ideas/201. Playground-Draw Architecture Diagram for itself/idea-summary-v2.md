...
- **Data Layer:** Project Files (docs/, src/, static/), Configuration (config/tools.json, .x-ipe.yaml), Session Data (instance/)
...
- [x] Diagrams stored in current idea folder (`docs/ideas/Draw Architecture Diagram for itself/architecture/`)
...
- Store in current idea folder first (`docs/ideas/Draw Architecture Diagram for itself/`)
