...
| FEATURE-025-D | KB Topics & Summaries | v1.0 | Complete | [specification.md](../requirements/FEATURE-025-D/specification.md), [technical-design.md](../requirements/FEATURE-025-D/technical-design.md), [acceptance-test-cases.md](../requirements/FEATURE-025-D/acceptance-test-cases.md) | 02-05-2026 | 02-12-2026 14:46:00 |
...
| FEATURE-030-A | UIUX Reference Tab & Console Integration | v1.0 | Tested | [specification.md](../requirements/FEATURE-030-A/specification.md) | 02-13-2026 | 02-13-2026 09:35:00 |
...
**Specification:** [x-ipe-docs/requirements/FEATURE-010/specification.md](../requirements/FEATURE-010/specification.md)  
**Technical Design:** [x-ipe-docs/requirements/FEATURE-010/technical-design.md](../requirements/FEATURE-010/technical-design.md)  
...
- Mockup: `x-ipe-docs/requirements/FEATURE-011/mockups/stage-toolbox-modal.html`
...
**Source:**
- Idea Summary: `x-ipe-docs/ideas/architecture dsl skills/idea-summary-v2.md`
- Mockup: `x-ipe-docs/ideas/architecture dsl skills/mockups/architecture-dsl-demo-v4.html`
...
**Source:**
- Change Request: `x-ipe-docs/requirements/FEATURE-016/CR-001.md`
- Requirements: `x-ipe-docs/requirements/requirement-details-part-2.md`
...
**Key Capabilities:**
- Creates `x-ipe-docs/` folder structure (ideas, planning, requirements, themes)
...
**Technical Design:** [technical-design.md](../requirements/FEATURE-022-A/technical-design.md)  
...
- TASK-205 (Technical Design) - Completed on 01-28-2026
...
- TASK-290: Test Generation (Pulse) — 57 tests, TDD ready
- TASK-291: Code Implementation (Pulse) — 111/111 tests pass
...
**Version:** v1.0  
**Status:** Implemented  
**Description:** Translate canonical X-IPE skills to each CLI's native format. Copilot = no-op, OpenCode = frontmatter filter, Claude Code = frontmatter preserve.  
...
**Implementation:** [skill_translator.py](../../src/x_ipe/services/skill_translator.py), [test_skill_translator.py](../../tests/test_skill_translator.py)  
