...
| TASK-850 | Change Request | CR: Replace all native browser dialogs (alert/confirm/prompt) with Bootstrap 5 modals across ~14 call sites in 6 JS files. Improve UX consistency. | Echo 📡 | 🔄 in_progress | 03-12-2026 07:10:00 | — | DAO-055 |
