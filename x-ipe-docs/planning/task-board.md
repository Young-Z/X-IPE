...
|---------|-----------|-------------|------|--------|--------------|--------------|----------|
| TASK-843 | Skill Update | Update x-ipe-task-based-feature-refinement: add "Test Type" column (UI/API/Unit/Integration) to AC table in specification template and skill procedure | Spark ✨ | ✅ done | 03-11-2026 13:28:00 | [SKILL.md](.github/skills/x-ipe-task-based-feature-refinement/SKILL.md), [spec-template](.github/skills/x-ipe-task-based-feature-refinement/references/specification-template.md) | - |
