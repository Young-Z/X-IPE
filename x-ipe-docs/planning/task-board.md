...
| TASK-851 | Bug Fix | Fix 2 KB sidebar UX bugs: (1) Intake placeholder appears clickable but is non-functional — add disabled style + "Coming Soon" tooltip. (2) KB browse requires undiscoverable double-click — add visible entry point. | Echo 📡 | 🔄 in_progress | 03-12-2026 07:35:00 | — | DAO-058 |
