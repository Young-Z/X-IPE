...
| TASK-857 | Bug Fix | Intake view doesn't show uploaded files — _renderIntakeScene() uses hardcoded zeros, trigger-intake-upload closes modal, intake files not persisted on scene re-render | Echo 📡 | 🔄 in_progress | 03-13-2026 00:18:00 | | DAO-062 |
