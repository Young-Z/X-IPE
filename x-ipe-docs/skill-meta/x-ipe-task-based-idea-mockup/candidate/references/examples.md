...
8. Update Summary:
   - Update existing x-ipe-docs/ideas/mobile-app-idea/idea-summary-v1.md with mockup links in-place
...
11. Resume Task Flow from x-ipe-workflow-task-execution skill
```
