...
```json
{
  ...
  "stages": {
    "ideation": {
      "mockup": {
        "x-ipe-tool-frontend-design": true
      }
    }
  }
}
...
|------------|------------------|-----------------|
| `stages.ideation.mockup.x-ipe-tool-frontend-design` | `x-ipe-tool-frontend-design` skill | HTML/CSS mockups, interactive prototypes |
...
**IF `stages.ideation.mockup.x-ipe-tool-frontend-design: true`:**
```
1. Invoke `x-ipe-tool-frontend-design` skill
2. Pass context:
...
├── idea-summary-vN.md
├── mockups/
│   ├── dashboard-v1.html      (if x-ipe-tool-frontend-design used)
│   ├── dashboard-v1.css       (if x-ipe-tool-frontend-design used)
│   ├── form-v1.html           (if x-ipe-tool-frontend-design used)
...
**Add to existing idea-summary (in-place):**
```markdown
## Mockups & Prototypes

| Mockup | Type | Path | Tool Used |
|--------|------|------|-----------|
| Dashboard | HTML | mockups/dashboard-v1.html | x-ipe-tool-frontend-design |
| User Form | HTML | mockups/user-form-v1.html | x-ipe-tool-frontend-design |
...
task_output_links:
  - {Current Idea Folder}/mockups/dashboard-v1.html
  - {Current Idea Folder}/mockups/user-form-v1.html
  - {Current Idea Folder}/idea-summary-vN.md
```
