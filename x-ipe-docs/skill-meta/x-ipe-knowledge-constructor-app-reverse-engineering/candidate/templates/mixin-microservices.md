...
> Merge these overlays into the base playbook when repo_type: microservices.
...
Add to Section 6 (Infrastructure Analysis):
...
### For Section 4 (Data Model Analysis)
<!-- ADDITIONAL PROMPTS:
- Identify per-service database schemas
- Document cross-service data consistency patterns
- Map event-driven data propagation between services
-->
