...
- Call input detection heuristics (see \`x-ipe-docs/skill-meta/x-ipe-task-based-application-knowledge-extractor/candidate/references/input-detection-heuristics.md\`)
...
- ✅ Format is one of: markdown, python, javascript, html, mixed, yaml, json, unknown
...
- Input analysis output template: \`x-ipe-docs/skill-meta/x-ipe-task-based-application-knowledge-extractor/candidate/templates/input-analysis-output.md\`
...
- Create checkpoint directory structure:
  ...
  ```
- Write session manifest YAML using template: \`x-ipe-docs/skill-meta/x-ipe-task-based-application-knowledge-extractor/candidate/templates/checkpoint-manifest.md\`
...
task_completion_output:
  ...
  input_analysis:
    ...
    format: "mixed | markdown | python | javascript | html | yaml | json | unknown"
...
For detailed execution examples, see: \`x-ipe-docs/skill-meta/x-ipe-task-based-application-knowledge-extractor/candidate/references/examples.md\`
