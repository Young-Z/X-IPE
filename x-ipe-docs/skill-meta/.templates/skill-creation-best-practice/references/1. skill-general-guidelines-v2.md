...
See [2. reference-section-order.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/2. reference-section-order.md) for full section order by skill type.
...
- [3. example-step-based-code-review.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/3. example-step-based-code-review.md) - Code review with multi-component steps
- [4. example-step-based-feature-implementation.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/4. example-step-based-feature-implementation.md) - TDD-based feature implementation
...
See examples in this folder:
- [5. example-function-based-validation.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/5. example-function-based-validation.md) - Validation utilities library
- [6. example-function-based-analysis.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/6. example-function-based-analysis.md) - Code analysis toolkit
...
See [7. example-task-io-code-implementation.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/7. example-task-io-code-implementation.md) for complete input/output example.
...
See [8. example-structured-summary.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/8. example-structured-summary.md) for examples (Feature, Dependency, Requirement, Test Coverage).
...
See [9. example-dor-dod.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/9. example-dor-dod.md) for examples (Code Implementation, Feature Refinement).
...
See [10. example-gate-conditions.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/10. example-gate-conditions.md) for examples (Quality Gate, Approval Gate, Release Gate).
...
See [11. reference-quality-standards.md](x-ipe-docs/skill-meta/.templates/skill-creation-best-practice/references/11. reference-quality-standards.md) for:
