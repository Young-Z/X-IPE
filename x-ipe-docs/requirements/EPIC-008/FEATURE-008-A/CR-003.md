...
2. Toolbox opens a panel/dropdown with 3 sections:
   - **Ideation**: x-ipe-tool-infographic-syntax (checkbox), mermaid (checkbox)
...
- AC-26: Ideation section contains checkboxes: x-ipe-tool-infographic-syntax, mermaid
...
- Feature Specification: [specification.md](x-ipe-docs/requirements/EPIC-008/FEATURE-008-A/specification.md)
