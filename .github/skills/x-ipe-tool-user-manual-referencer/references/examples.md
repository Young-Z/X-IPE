# User Manual Referencer — Examples

## Example 1: Retrieve Step-by-Step for Creating a New Workflow

**Scenario:** The `x-ipe-task-based-general-purpose-executor` is executing a task that requires creating a new workflow in the application. It calls the referencer to get instructions.
