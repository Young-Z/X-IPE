...
└── requirements/
    ...
    ├── features.md                     # Feature board (managed by @feature-stage)
    ├── FEATURE-001/
    │   └── specification.md
    ├── FEATURE-002/
    │   └── specification.md
...
|-----------------|-----------|
| task-type-requirement-gathering-@requirement-stage | Update Requirement Summary |
| task-type-feature-breakdown-@requirement-stage | Track Feature Breakdown |
