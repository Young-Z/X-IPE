# Assistant Skill Template

Use this template for skills (type: `x-ipe-assistant`) that act as human representatives at human-required touchpoints while preserving bounded outputs and optional human-shadow fallback. The 格物致知 (Investigate to Reach Understanding) framework is the CORE internal reasoning methodology for all skills of this type.
...
See `.github/skills/x-ipe-assistant-{name}/references/examples.md` for usage examples.
```
