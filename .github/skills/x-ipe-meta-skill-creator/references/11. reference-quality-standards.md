...
anti_patterns:
  ...
  - pattern: DoR/DoD checkpoint overrun
    reason: Too many checkpoints dilute focus and waste agent tokens
    fix: "DoR ≤ 5 checkpoints, DoD ≤ 10 checkpoints. Merge related checks, keep only critical ones."
  ...
  - pattern: SKILL.md > 500 lines (> 600 for x-ipe-tool type)
